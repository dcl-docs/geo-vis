...
The result should be a downloaded PNG, which you can view from RStudio or a browser. If this didn't work, you may need to set the a different download method through the `method` argument of `download.file()`.
