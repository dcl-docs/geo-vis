...
* When you publish your map, you'll get a URL that points to your published map. Your published map will have a starting location and zoom level. By default, Studio will set this location and zoom level to the location and zoom level of your map at the time of publishing. Before clicking __Publish__, make sure you're happy with the current location and zoom level.
* You can also see the exact longitude, latitude, and zoom level by clicking on __Map position__.
...
* To finalize your map, adjust the longitude, latitude, and zoom of your map so that your published map defaults to the correct location and zoom level.
